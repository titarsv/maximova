...
define('QT_SUPPORTED_WP_VERSION', '4.3.1');
define('QT_STRING',		1);
define('QT_BOOLEAN',	2);
define('QT_INTEGER',	3);
define('QT_URL',		4);
...
$q_config['not_available']['ru'] = "Извение, но эта статья доступна только на %LANG:, : и %";
